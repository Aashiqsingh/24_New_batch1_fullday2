function singapore(name,amt){
    ...
    return name + " your picnic singapore confirm with amount " + amt;
...
function goa(name,amt){
    ...
    return name + " your picnic goa confirm with amount " + amt;
...
function paris(name,amt){
    ...
    return name + " your picnic paris confirm with amount " + amt;
 }
